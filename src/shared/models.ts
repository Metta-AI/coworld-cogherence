...
export const BEDROCK_MODELS: BedrockModel[] = [
  ...
  { id: "us.anthropic.claude-sonnet-4-6", label: "Sonnet 4.6", enabled: true },
  { id: "us.anthropic.claude-sonnet-4-20250514-v1:0", label: "Sonnet 4", enabled: true },
  { id: "us.anthropic.claude-haiku-4-5-20251001-v1:0", label: "Haiku 4.5 — needs form", enabled: false },
];

/** Default autopilot model (a fast, capable model enabled on softmax-org). */
